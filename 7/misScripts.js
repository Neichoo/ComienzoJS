...
function calcular() {
    ...
    for (let item of elementosVentas.children) {
        item.children[1].classList.remove('ventaMayor', 'ventaMenor');
    }
    ...
    for (let item of elementosVentas.children) {
        ...
        if (valorVenta === ventaMayor) {
            item.children[1].classList.add('ventaMayor');
        } else if (valorVenta === ventaMenor) {
            item.children[1].classList.add('ventaMenor');
        }
    }
